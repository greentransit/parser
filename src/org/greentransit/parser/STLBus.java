...
public class STLBus implements GAgencyTools {
	...
	public static final String SERVICE_ID_FILTER = "JANV13"; // TODO use calendar
...
//		System.exit(0);
	...
	public String getRouteLongName(GRoute gRoute) {
		// AOUT1212E,STL,12,Direction Pont-Viau,3,http://www.stl.laval.qc.ca/lang/fr/horaires-et-trajets/?page_id=2361&route_id=12E,Pont-Viau,CC9900,000000
	...
	public String cleanStopName(String gStopName) {
		...
		// Terminus Henri-Bourassa Quai:6 [20011] => Terminus Henri-Bourassa Quai:6
...
//		return stop_id.substring(stop_id.length() - 5); // keep the last 5 characters
//	}
//
