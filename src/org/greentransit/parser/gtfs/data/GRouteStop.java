...
/**
 * GTFS route, as NOT defined at https://developers.google.com/transit/gtfs/reference
 * 
 * @author Mathieu Méa
 */
@Deprecated
public class GRouteStop {
	...
	public GRouteStop(String route_id, String stop_id, int stop_sequence, GPickupType pickup_type, GDropOffType drop_off_type) {
